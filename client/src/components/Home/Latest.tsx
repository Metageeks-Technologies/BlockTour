      ...
      <div className="lg:basis-[69%] md:basis-[60%] w-full ">
        ...
        <div className=" flex justify-between text-white">
          <div className="flex gap-3 items-center">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/d506a806ee546f3b309a9abe5a4b631f14090186ee32bbf1cfef3f5ea71299fc?placeholderIfAbsent=true&apiKey=edd8c588fa7b4e2c93b6125029a35184"
              alt=""
            />
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-8 mt-4">
          {publishedPosts?.map((card:any) => (
            <div key={card._id} className=" flex flex-col gap-5  ">
              <img
                loading="lazy"
          ...
          <div className="flex gap-5 lg:flex-row md:flex-col justify-between mt-12 w-full max-md:mt-10">
            <div className="flex gap-3">
              <img
                ...
                className="object-contain shrink-0 aspect-square rounded-[60px] w-[60px]"
              />

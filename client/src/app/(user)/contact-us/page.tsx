  ...
  return (
    <div className="lg:ml-52 w-full">
      <div className="lg:w-[90%] m-auto ">
        <div className="flex sm:flex-row flex-col lg:px-1 sm:px-6 px-4">
          <div className="flex justify-center py-12 lg:w-[70%] ">
              ...
              <div className="border border-[#333333] grid grid-cols-3 p-5">
                <div className="flex justify-center items-center border-r border-[#333333]">
                  <div className="flex flex-col items-center ">
                    ...
                    <p className="text-white lg:block hidden">support@blocktour.org</p>
                  </div>
                </div>
                ...
                <div className="flex justify-center items-center border-r border-[#333333]">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-white lg:block hidden">+9198107928XX</p>
                  </div>
                </div>
                ...
                <div className="flex justify-center items-center">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-white lg:block hidden ">Lorem ipsum dolor sit,</p>
                  </div>
                </div>
              </div>
          ...
          <div className="w-[35%] lg:pl-8 mt-4 sm:block hidden ">
            <div className="relative border border-[#28272D] rounded flex justify-between">
              <input
                type="text"
                placeholder="Search"
                className="bg-[#0A090F] text-[#7B7A7F] lg:w-80 w-40 sm:w-full px-4 py-2 rounded border-none focus:outline-none"
              />

...
const AddPostPage = () => {
  ...
  const handleSubmit = async ( e: React.FormEvent<HTMLFormElement> ) => {
    ...
    try {
      ...
      const response = await instance.post( "/post/contributor/posts", updatedData );
  ...
  if ( !user.contributor ) {
    return (
      <div>
        <UserHearder />
        <div className="bg-[#0A090F] text-white m-4 rounded-2xl border border-[#28272D]">
          <div className="border-b border-[#28272D] px-4 py-4">
            <h1 className="text-2xl px-6">Add New Post</h1>
          </div>
          <div className="flex items-center justify-center w-full h-96">
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-2xl">You are not a contributor</h1>
              <p className="text-lg text-center">Once admin aprove you than you can make a post, it make take up to 48 hrs.</p>
              <button
                className="bg-[#7B7A7F] text-white py-2 px-4 rounded-lg hover:bg-gray-600 mt-4"
            ...
            <div className="flex flex-col rounded-none max-w-md mx-auto mt-5">
              <div className="flex flex-col py-5 w-full rounded-md border border-solid border-neutral-700">
                ...
                <div className="flex items-center justify-center w-full mt-5 px-4">
                  <label htmlFor="preview-image-upload"  className="flex flex-col items-center justify-center cursor-pointer w-full border-2 border-dashed border-[#7B7A7F] rounded-lg p-4" >
